 ...
 *
 */
package net.mcreator.changedmod;
...
@Mod("changed")
public class ChangedMod {
	public static final Logger LOGGER = LogManager.getLogger(ChangedMod.class);
	...
	public ChangedMod() {
		...
		ChangedModSounds.REGISTRY.register(bus);
