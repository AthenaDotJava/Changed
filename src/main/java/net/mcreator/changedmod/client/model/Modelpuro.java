...
public class Modelpuro<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("changed", "modelpuro"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition right = Ears.addOrReplaceChild("right",
				CubeListBuilder.create().texOffs(0, 65).addBox(0.0F, -1.0F, -3.0F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 80)
		...
		PartDefinition left = Ears.addOrReplaceChild("left",
				CubeListBuilder.create().texOffs(24, 66).addBox(-1.0F, -1.0F, -2.0F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(32, 74)
		...
		PartDefinition headwear = partdefinition
				.addOrReplaceChild(
						"headwear", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.5F))
								.texOffs(71, 0).addBox(-2.0F, -3.0F, -7.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(-1.0F)),
						PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 32).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition jacket = partdefinition.addOrReplaceChild("jacket",
				CubeListBuilder.create().texOffs(28, 28).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm",
				CubeListBuilder.create().texOffs(56, 0).addBox(-1.0F, -2.0F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(5.0F, 2.0F, 0.0F));
		PartDefinition left_sleve = partdefinition.addOrReplaceChild("left_sleve",
				CubeListBuilder.create().texOffs(52, 44).addBox(-1.0F, -2.0F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)),
				PartPose.offset(5.0F, 2.0F, 0.0F));
		PartDefinition right_arm = partdefinition.addOrReplaceChild("right_arm",
				CubeListBuilder.create().texOffs(52, 28).addBox(-2.0F, -2.0F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-5.0F, 2.0F, 0.0F));
		PartDefinition right_sleve = partdefinition.addOrReplaceChild("right_sleve",
				CubeListBuilder.create().texOffs(0, 48).addBox(-2.0F, -2.0F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)),
				PartPose.offset(-5.0F, 2.0F, 0.0F));
		PartDefinition left_leg = partdefinition.addOrReplaceChild("left_leg",
				CubeListBuilder.create().texOffs(36, 44).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(2.0F, 12.0F, 0.0F));
		PartDefinition left_pants = partdefinition.addOrReplaceChild("left_pants",
				CubeListBuilder.create().texOffs(20, 44).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)),
				PartPose.offset(2.0F, 12.0F, 0.0F));
		PartDefinition right_leg = partdefinition.addOrReplaceChild("right_leg",
				CubeListBuilder.create().texOffs(44, 12).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.0F, 12.0F, 0.0F));
		PartDefinition right_pants = partdefinition.addOrReplaceChild("right_pants",
				CubeListBuilder.create().texOffs(32, 0).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)),
				PartPose.offset(-2.0F, 12.0F, 0.0F));
		...
		PartDefinition cube_r1 = tail1.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(72, 10).addBox(-1.0F, 3.0F, -7.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -1.393F, 8.2533F, -0.3491F, 0.0F, 0.0F));
		PartDefinition tail2 = tail1.addOrReplaceChild("tail2", CubeListBuilder.create(), PartPose.offset(0.0F, 1.607F, 2.2533F));
		PartDefinition cube_r2 = tail2.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(73, 21).addBox(-2.0F, 2.5F, -5.0F, 4.0F, 4.0F, 3.0F, new CubeDeformation(-0.5F)),
				PartPose.offsetAndRotation(0.0F, -3.0F, 6.0F, -0.4363F, 0.0F, 0.0F));
		PartDefinition tail3 = tail2.addOrReplaceChild("tail3", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 1.0F));
		PartDefinition cube_r3 = tail3.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(72, 31).addBox(-3.0F, 1.25F, -4.0F, 6.0F, 6.0F, 3.0F, new CubeDeformation(-0.5F)),
				PartPose.offsetAndRotation(0.0F, -3.0F, 5.0F, -0.3491F, 0.0F, 0.0F));
		PartDefinition tail4 = tail3.addOrReplaceChild("tail4", CubeListBuilder.create(), PartPose.offset(0.0F, 1.0F, 2.0F));
		PartDefinition cube_r4 = tail4.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(89, 1).addBox(-3.0F, 6.2322F, -4.8022F, 6.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -7.0F, 8.0F, -0.3927F, 0.0F, 0.0F));
		PartDefinition tail5 = tail4.addOrReplaceChild("tail5", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 1.0F));
		PartDefinition cube_r5 = tail5.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(94, 38).addBox(-4.0F, 4.969F, -4.2258F, 8.0F, 8.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -7.0F, 7.0F, -0.3054F, 0.0F, 0.0F));
		PartDefinition tail6 = tail5.addOrReplaceChild("tail6", CubeListBuilder.create(), PartPose.offset(0.0F, 3.0F, 9.0F));
		PartDefinition cube_r6 = tail6.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(108, 21).addBox(-3.0F, 6.3372F, -6.0038F, 6.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -10.0F, -2.0F, -3.0107F, 0.0F, 3.1416F));
		PartDefinition tail7 = tail6.addOrReplaceChild("tail7", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 2.0F));
		PartDefinition cube_r7 = tail7.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(85, 11).addBox(-3.0F, 6.3678F, -8.6019F, 6.0F, 6.0F, 5.0F, new CubeDeformation(-0.5F)),
				PartPose.offsetAndRotation(0.0F, -10.0F, -4.0F, -3.098F, 0.0F, 3.1416F));
		PartDefinition tail8 = tail7.addOrReplaceChild("tail8", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 4.0F));
		PartDefinition cube_r8 = tail8.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(108, 10).addBox(-2.0F, 8.119F, -10.3676F, 4.0F, 4.0F, 4.0F, new CubeDeformation(-0.5F)),
				PartPose.offsetAndRotation(0.0F, -10.0F, -8.0F, 3.1416F, 0.0F, 3.1416F));
		PartDefinition tail9 = tail8.addOrReplaceChild("tail9", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 2.0F));
		PartDefinition cube_r9 = tail9.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(117, 3).addBox(-1.0F, 9.1095F, 9.1117F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
