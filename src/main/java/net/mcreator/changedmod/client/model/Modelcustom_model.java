...
public class Modelcustom_model<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("changed", "modelcustom_model"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition headwear = partdefinition.addOrReplaceChild("headwear",
				...
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition ears = headwear.addOrReplaceChild("ears", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition left = ears.addOrReplaceChild("left",
				CubeListBuilder.create().texOffs(54, 46).addBox(-1.0F, -1.0F, -4.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(24, 16)
		...
		PartDefinition right = ears.addOrReplaceChild("right",
				CubeListBuilder.create().texOffs(75, 12).addBox(-2.0F, -1.0F, -4.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(83, 0)
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(32, 0).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition jacket = partdefinition.addOrReplaceChild("jacket",
				CubeListBuilder.create().texOffs(0, 32).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition left_sleve = partdefinition.addOrReplaceChild("left_sleve",
				CubeListBuilder.create().texOffs(44, 52).addBox(-1.0F, -2.0F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)),
				PartPose.offset(5.0F, 2.0F, 0.0F));
		PartDefinition right_arm = partdefinition.addOrReplaceChild("right_arm",
				CubeListBuilder.create().texOffs(30, 52).addBox(-2.0F, -2.0F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-5.0F, 2.0F, 0.0F));
		PartDefinition right_sleve = partdefinition.addOrReplaceChild("right_sleve",
				CubeListBuilder.create().texOffs(16, 52).addBox(-2.0F, -2.0F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)),
				PartPose.offset(-5.0F, 2.0F, 0.0F));
		...
		PartDefinition left_pants = partdefinition.addOrReplaceChild("left_pants",
				CubeListBuilder.create().texOffs(40, 36).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)),
				PartPose.offset(2.0F, 12.0F, 0.0F));
		PartDefinition right_leg = partdefinition.addOrReplaceChild("right_leg",
				CubeListBuilder.create().texOffs(40, 16).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.0F, 12.0F, 0.0F));
		PartDefinition right_pants = partdefinition.addOrReplaceChild("right_pants",
				CubeListBuilder.create().texOffs(24, 36).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)),
				PartPose.offset(-2.0F, 12.0F, 0.0F));
		PartDefinition tail = partdefinition.addOrReplaceChild("tail", CubeListBuilder.create(), PartPose.offset(0.0F, 11.0F, 2.0F));
		PartDefinition main = tail.addOrReplaceChild("main", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition cube_r1 = main.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(22, 22).addBox(-2.0F, -1.0F, 7.0F, 4.0F, 4.0F, 10.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.5236F, 0.0F, 0.0F));
		PartDefinition cube_r2 = main.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(50, 26).addBox(-1.5F, 1.5F, 16.0F, 3.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.384F, 0.0F, 0.0F));
		PartDefinition cube_r3 = main.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(22, 102).addBox(-1.5F, -1.5F, 1.0F, 3.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 4)
						.addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.6545F, 0.0F, 0.0F));
		PartDefinition middle_tail_fin = tail.addOrReplaceChild("middle_tail_fin", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition cube_r4 = middle_tail_fin.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(24, 0).addBox(-0.5F, -5.0F, 13.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-0.5F, -4.0F, 12.0F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(52, 35)
						.addBox(-0.5F, -3.0F, 11.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(46, 71).addBox(-0.5F, -2.0F, 10.0F, 1.0F,
								1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.5236F, 0.0F, 0.0F));
		PartDefinition end_tail_fin = tail.addOrReplaceChild("end_tail_fin", CubeListBuilder.create(), PartPose.offset(0.0F, 3.0F, -1.0F));
		PartDefinition cube_r5 = end_tail_fin.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(24, 3).addBox(-0.5F, -4.0F, 21.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.2F)),
				PartPose.offsetAndRotation(0.0F, 3.0F, -1.0F, -0.384F, 0.0F, 0.0F));
		PartDefinition top = end_tail_fin.addOrReplaceChild("top", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition cube_r6 = top.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(11, 83).addBox(-0.5F, -7.0F, 23.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 110)
						...
						.addBox(-0.5F, -3.0F, 19.0F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 74).addBox(-0.5F, -2.0F, 18.0F, 1.0F,
								1.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.384F, 0.0F, 0.0F));
		PartDefinition bottom = end_tail_fin.addOrReplaceChild("bottom", CubeListBuilder.create(), PartPose.offset(0.0F, 3.0F, -1.0F));
		PartDefinition cube_r7 = bottom.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(28, 69).addBox(-0.5F, 3.0F, 23.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(16, 69)
						...
						.addBox(-0.5F, -1.0F, 19.0F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(19, 78).addBox(-0.5F, -2.0F, 18.0F, 1.0F,
								1.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.384F, 0.0F, 0.0F));
